    ...
    <body>
		...
		<div id="homeHeaderTitle">
            ...
            <section>
                <div>
                    <%
                    ArrayList<User> users = (ArrayList<User>) request.getSession().getAttribute("pendingUsers");
                    if(users!= null && users.size()>0){
                        for(int i=0; i<users.size() ; i++) {
                            ...
                            out.print("<h6 style='margin-left: 10px;'><a href='MainServlet/ApproveAdmin?userId="+user.getId()+"'>Approve</a>&nbsp;&nbsp;&nbsp;<a href='MainServlet/DeclineAdmin?userId="+user.getId()+"'>Decline</a></h6>");
                            out.print("</div>");
                        }
                    }else{
                        out.println("<div><h4>No Pending Users</h4>");
                        out.println("</div>");
                    }
                    %>
                </div>
